...
- Do not reveal any personal information from the ticket (reporter, assignee, email, etc.) in the output.
- Do not write test cases or automation scripts — only a plan.
